    ...
    res.send({
		...
		data: {
			...
			data:[
                ...
                {list_id:7,list_name:'经典百搭型外套',list_img:'img/commodity1.jpg',list_price:349,list_uprice:228.7},
                {list_id:8,list_name:'穿梭恋人，保暖又迷人',list_img:'img/commodity2.jpg',list_price:549,list_uprice:428.7},
                {list_id:9,list_name:'春夏睡衣风',list_img:'img/commodity3.jpg',list_price:149,list_uprice:28.7},
                {list_id:10,list_name:'秋季外套',list_img:'img/commodity4.jpg',list_price:649,list_uprice:528.7},
                {list_id:11,list_name:'圆领长袖X',list_img:'img/commodity2.jpg',list_price:49,list_uprice:28.7},
                {list_id:12,list_name:'可爱迷人百褶裙',list_img:'img/commodity3.jpg',list_price:1349,list_uprice:1228.7},
            ]
		}
    })
})
